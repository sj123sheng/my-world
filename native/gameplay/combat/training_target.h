...
class TrainingTarget {
 public:
  ...
  bool poiseBroken(Tick now) const { return breakUntil_ > now; }
  bool corroded() const;
  ...
  void applyCorrosion(Tick until) { corrosionUntil_ = std::max(corrosionUntil_, until); }
