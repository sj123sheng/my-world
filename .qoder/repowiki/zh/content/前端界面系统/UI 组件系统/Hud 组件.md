...
- [Hud.ets:57-143](file://entry/src/main/ets/ui/Hud.ets#L57-L143)
...
章节来源
- [Hud.ets:2-55](file://entry/src/main/ets/ui/Hud.ets#L2-L55)
- [GamePage.ets:31-95](file://entry/src/main/ets/pages/GamePage.ets#L31-L95)
...
```mermaid
sequenceDiagram
participant Native as "原生层(game_snapshot.h)"
...
- [game_snapshot.h:7-73](file://native/engine/core/game_snapshot.h#L7-L73)
- [Hud.ets:67-136](file://entry/src/main/ets/ui/Hud.ets#L67-L136)
...
章节来源
- [Hud.ets:67-78](file://entry/src/main/ets/ui/Hud.ets#L67-L78)
- [Hud.ets:115-116](file://entry/src/main/ets/ui/Hud.ets#L115-L116)
- [Bridge.ets:56-74](file://entry/src/main/ets/napi/Bridge.ets#L56-L74)
...
章节来源
- [Hud.ets:104-136](file://entry/src/main/ets/ui/Hud.ets#L104-L136)
- [CombatControls.ets:20-22](file://entry/src/main/ets/ui/CombatControls.ets#L20-L22)
- [Bridge.ets:91](file://entry/src/main/ets/napi/Bridge.ets#L91)
...
章节来源
- [GamePage.ets:183-208](file://entry/src/main/ets/pages/GamePage.ets#L183-L208)
- [Hud.ets:82-99](file://entry/src/main/ets/ui/Hud.ets#L82-L99)
...
- 调试面板不显示：检查 showDebugHud 与 debugHud 两个开关是否同时为真。
...
## 结论
Hud 组件以简洁的 @Prop 接口承接上层状态，通过 ArkUI 响应式机制实现高效渲染。其与 GamePage、Bridge、原生快照之间的清晰分层确保了可维护性与可扩展性。Boss 战与调试模式的特殊逻辑进一步增强了实战可用性。建议在实际使用中遵循本文档的样式与动画指南，并结合性能优化策略，以获得更流畅的用户体验。
